  ...
  return (
    <div>
      <div className="p-6 max-w-7xl mx-auto">
        ...
        {isStudent && (
          <div className="mb-8">
            <Button variant="contained" color="primary" onClick={() => navigate("/upload")} sx={{ mb: 4 }}>
              อัปโหลดผลงานใหม่
            </Button>
          </div>
        )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card className="bg-gradient-to-br from-green-50 to-green-100 shadow-md">
                <CardContent>
                  ...
                  <Typography variant="h4" className="font-bold text-green-700">{stats.uploadCount7d ?? 0}</Typography>
                </CardContent>
              </Card>
            </div>
              ...
              <Card>
                <CardContent>
                  ...
                  {stats.topCategories?.length > 0 ? (
                    <ResponsiveContainer width="100%" height={300}>
                      <PieChart>
                        <Pie data={stats.topCategories} dataKey="count" nameKey="category" outerRadius={100} label>
          ...
          {popularDocs.length === 0 ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              {popularDocs
                ...
                .slice(0, 6)
                .map((doc) => (
                  <Card key={doc.document_id} className="shadow-lg hover:shadow-2xl transition rounded-xl border border-brand-100/70">
                    <CardContent>
                      ...
                      <Typography variant="body2" color="text.secondary" className="mb-2">
                        ดาวน์โหลด: {Number(doc.download_count || 0)} ครั้ง
                      </Typography>
                    </CardContent>
